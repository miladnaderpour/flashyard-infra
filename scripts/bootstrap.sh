...
# Disk setup confirmation

# ===============================

read -rp "Run disk setup on ${DISK_DEVICE}? (will partition/format) type yes to continue: " RUN_DISK

if [[ "$RUN_DISK" == "yes" ]]; then
...
read -rp "Install/configure Docker? type yes to continue: " RUN_DOCKER
